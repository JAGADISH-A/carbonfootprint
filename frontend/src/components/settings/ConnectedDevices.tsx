...
export default function ConnectedDevices() {
  ...
  const connectedDeviceVersion = devices.length > 0 ? devices[0].appVersion : undefined
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {/* Companion Download — compact, for update scenario */}
          <div className="pt-6 border-t border-gray-100">
            <CompanionDownload connectedDeviceVersion={connectedDeviceVersion} />
          </div>
        </>
      ) : (
        /* No Device Connected — Download + Pair */
        <div className="space-y-6">
          <div className="text-center py-4 bg-white border border-dashed border-gray-300 rounded-xl">
            <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
            <h3 className="mt-2 text-sm font-medium text-gray-900">No companion device connected</h3>
            <p className="mt-1 text-sm text-gray-500">
              Download the Android Companion app and pair your device to get started.
            </p>
            <div className="mt-4">
              <button
                onClick={() => setIsModalOpen(true)}
